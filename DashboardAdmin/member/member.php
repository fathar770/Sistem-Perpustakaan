  ...
  <body>
    ...
    <thead>
        <tr>
            ...
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">Kode</th>
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">Nama</th>
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">Jenis Kelamin</th>
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">Jurusan</th>
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">No Telepon</th>
            <th style="padding:8px; border:1px solid #ccc; background:#007bff; color:white;">Pendaftaran</th>
